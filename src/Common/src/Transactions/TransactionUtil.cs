...
public class TransactionScopeHandler : ITransactionScopeHandler
{
    ...
    protected static TransactionScope CreateScope(TransactionScopeOption scopeOption = TransactionScopeOption.Required)
        => new(scopeOption, DefaultTransactionOptions, TransactionScopeAsyncFlowOption.Enabled);
}
